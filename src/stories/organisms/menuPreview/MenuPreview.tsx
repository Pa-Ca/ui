...
import { Plate } from '../../molecules/plate/Plate';
...
export const MenuPreview = ({
  ...
  return (
    <Box className='menu-preview--container' style={{ width, height }} innerRef={observer.ref}>
      <Box className='menu-preview--header'>
        <Text type='h5' color='#112211' weight='700'>
          Menú
        </Text>

        <Button primary size='extra-large' backgroundColor={color} onClick={onButtonClick}>
