...
interface BranchProductsResumeProps {
    ...
    onViewMoreHighlightsClick?: () => void;
}
            ...
            >
                ...
                <Box>
                    ...
                    >
                        ...
                        <Button primary onClick={onViewMoreHighlightsClick}>
                            <Text primaryButtonStyle>Ver mas</Text>
                        </Button>
                    </Box>
                    ...
                    >
                        <Box style={{ display: "flex", flex: 1, justifyContent: "space-between" }}>
                            ...
                            {new Array(Math.max(0, 4 - highlightProducts.length))
                                .fill(0)
                                .map((_, index) => (
                                    <Box
                                        key={index}
                                    ...
                                    >
                                        <AddBox
                                            onClick={onAddHighlightProduct}
                                            size={`${observer.width / 5 - 80}px`}
                                        />
                                    </Box>
                                ))}
                        </Box>
                        ...
                        <Box style={{ display: "flex", flex: 1, justifyContent: "space-between" }}>
                            {cupons.map((product, index) => (
                                <Box
                                    ...
                                    style={{ display: "flex", flex: 1, justifyContent: "center" }}
                                >
                                    <SimpleProductCard {...product} width="70%" />
                                </Box>
                            ))}
