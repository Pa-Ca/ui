...
export default {
  title: "Design System/Templates/RecoverPassword",
...
} as Meta<typeof RecoverPassword>;

// More on component templates: https://storybook.js.org/docs/react/writing-stories/introduction#using-args
const Template: StoryFn<typeof RecoverPassword> = (args: any) => {
  const password = useInputForm("");

  return <RecoverPassword password={password} {...args} />;
};
