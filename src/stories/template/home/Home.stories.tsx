...
const globalArgs = {
  ...
  getCategoryCards: () =>
    new Array(5).fill({
      ...
      backgroundImage:
        "https://img.chilango.com/2018/06/chimenea-sir-winston.jpg",
    }),
  getHihgLightReviews: () =>
    new Array(5).fill({
      ...
      image:
        "https://cc-prod.scene7.com/is/image/CCProdAuthor/7%20AdobeStock_335413355?$png$&jpegSize=200&wid=960",
      viewMore: () => {},
    }),
};
